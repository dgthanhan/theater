// modified version of the peerflix
...
var createServer = function (e, opts) {
    ...
    var fileRequestPath = "/" + fileName;
    var subtitleRequestPrefix = fileRequestPath.replace(/\.[a-z0-9]+$/, ".");
    ...
    server.on('request', function (request, response) {
            console.log("TORRENT HTTP:REQUEST:", request.url);
        ...
        if (u.pathname === '/' || u.pathname == subtitleRequestPrefix) u.pathname = '/' + index
